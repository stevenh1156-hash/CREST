...
namespace MCM.Tests
{
    internal sealed class TestSettingsPerSaveV2 : BaseTestPerSaveSettingsBase<TestSettingsPerSaveV2>
    {
        public override string Id => "TestingPerSave_v2_v5";
        public override string DisplayName => "MCMv5 Testing PerSave v2 API";
