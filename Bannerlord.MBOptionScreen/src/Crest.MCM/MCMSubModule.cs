...
# endif
    class MCMSubModule : MBSubModuleBase
    {
        ...
        /// <summary>
        /// CREST Phase L gate: returns true unless config.json has "MCM": false.
        /// Reflection into Bannerlord.Harmony.CrestConfig (loaded earlier) keeps this fork
        /// compile-time-independent of Bannerlord.Harmony's exposed surface.
        /// </summary>
