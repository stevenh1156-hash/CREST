...
public static class DelayedSubModuleManager
{
    ...
    {
        var loadedModules = Bannerlord.BUTR.Shared.Helpers.ModuleInfoHelper.GetLoadedModules().ToList();
        var callerModule = Bannerlord.BUTR.Shared.Helpers.ModuleInfoHelper.GetModuleByType(caller);
        var destModule = Bannerlord.BUTR.Shared.Helpers.ModuleInfoHelper.GetModuleByType(mbSubModuleType);
