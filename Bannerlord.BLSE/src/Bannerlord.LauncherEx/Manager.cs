...
public static class Manager
{
    ...
    public static void Enable()
    {
        ...
        // CREST Phase N: hide the four Bannerlord.X stub modules from the
        // launcher's mod list UI. Stubs still exist in ExtendedModuleInfoCache
        // (so engine dep-checks pass), but the user never sees them. See
        // Patches/HideCrestStubsPatch.cs for full rationale and the
        // CREST_SHOW_STUBS=1 escape hatch for debugging.
        HideCrestStubsPatch.Enable(_launcherHarmony);
