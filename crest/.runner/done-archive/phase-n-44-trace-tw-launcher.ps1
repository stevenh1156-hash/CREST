...
Write-Host ('Deployed at ' + (Get-Item (Join-Path $bin 'Bannerlord.BLSE.Shared.dll')).LastWriteTime.ToString('HH:mm:ss'))

# Launch via TW launcher (Steam path)
Write-Host '==> Launching TaleWorlds.MountAndBlade.Launcher.exe (Steam path)' -ForegroundColor Cyan
