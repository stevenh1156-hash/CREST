...
Write-Host '==> Test 1: dry-run on BloodMod1313 (single mod)' -ForegroundColor Cyan
...
Write-Host ''
Write-Host '==> Test 2: dry-run sweep across the 21 community mods to map coverage' -ForegroundColor Cyan
